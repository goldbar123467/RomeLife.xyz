...
export const WONDERS: Wonder[] = [
    {
        id: 'colosseum',
        name: 'Colosseum',
        latinName: 'Amphitheatrum Flavium',
        description: 'The greatest arena in the world, hosting gladiatorial combat and spectacles that defined Roman entertainment.',
    ...
    },
    {
        ...
        name: 'Pantheon',
        latinName: 'Pantheum',
        description: 'Temple dedicated to all the gods of Rome, crowned by the largest unreinforced concrete dome in history.',
    ...
    },
    {
        id: 'circus_maximus',
        name: 'Circus Maximus',
        latinName: 'Circus Maximus',
        description: 'The largest chariot racing stadium in Rome, where citizens gathered for the most thrilling spectacles.',
    ...
    },
    {
        id: 'aqua_claudia',
        name: 'Aqua Claudia',
        latinName: 'Aqua Claudia',
        description: 'One of the most impressive aqueducts of ancient Rome, bringing fresh water from distant springs.',
    ...
    },
    {
        id: 'forum_romanum',
        name: 'Forum Romanum',
        latinName: 'Forum Romanum',
        description: 'The beating heart of Roman civilization—center of commerce, law, religion, and political life.',
    ...
    },
    {
        ...
        latinName: 'Domus Augustana',
        description: 'The imperial residence atop the Palatine Hill, from which emperors ruled the known world.',
