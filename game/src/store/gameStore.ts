...
> => ({
    ...
    lastTroopNudgeRound: 0, // BL-53 / BL-58: recurring military-recruit nudge (every 8 rounds)
    conquestNudgeShown: false, // BL-54: one-shot conquest/expansion nudge
    patronNudgeShown: false, // BL-56: one-shot patron-god nudge
